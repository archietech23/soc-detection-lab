...
Both detections fired against real events in the lab. See the [incident report](docs/incident-report.md) for the connected narrative.
...
├── detections/
│   ├── kerberoasting.md          # detection card 1
│   └── password-spray.md         # detection card 2
├── docs/
│   ├── architecture.svg          # data flow diagram
│   ├── incident-report.md        # connected narrative of both attacks
│   ├── lab-environment.md        # hypervisor + learning resources
│   ├── SPLUNK-SETUP.md           # sensor + SIEM build runbook
...
1. [`docs/lab-environment.md`](docs/lab-environment.md) - what you need to run this (hypervisor, VMs, learning resources).
2. [`docs/SPLUNK-SETUP.md`](docs/SPLUNK-SETUP.md) - build the sensor and SIEM.
3. [`docs/attack-simulation.md`](docs/attack-simulation.md) - fire the attacks.
4. [`DEPLOY.md`](DEPLOY.md) - deploy the detections.
...
[LinkedIn](https://www.linkedin.com/in/archieplaquia/)
